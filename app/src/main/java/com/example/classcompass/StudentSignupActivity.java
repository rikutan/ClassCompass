...
public class StudentSignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ビューの取得
        EditText inputMail = findViewById(R.id.student_signup_inputMail);
        EditText inputPass = findViewById(R.id.student_signup_inputPass);
        EditText inputPassCheck = findViewById(R.id.student_signup_inputPassCheck);
        EditText inputName = findViewById(R.id.student_signup_inputName);
        EditText inputKana = findViewById(R.id.student_signup_inputKana);
        EditText inputYear = findViewById(R.id.student_signup_inputYear);
        EditText inputMonth = findViewById(R.id.student_signup_inputMonth);
        EditText inputDay = findViewById(R.id.student_signup_inputDay);

        TextView errorMail = findViewById(R.id.student_signup_err1);
        TextView errorPass = findViewById(R.id.student_signup_err2);
        TextView errorPassCheck = findViewById(R.id.student_signup_err3);
        TextView errorName = findViewById(R.id.student_signup_err4);
        TextView errorKana = findViewById(R.id.student_signup_err5);
        TextView errorDate = findViewById(R.id.student_signup_err6);
        ...
        // 戻る(TextView)ボタン
        TextView backtext = findViewById(R.id.student_signup_backtext);
        backtext.setOnClickListener(v -> {
            Intent intentBack = new Intent(this, StartStudentActivity.class);
            startActivity(intentBack);
        });

        // 次に進むボタン(入力データ転送)
        Button nextBtn = findViewById(R.id.student_signup_nextBtn);
        nextBtn.setOnClickListener(v -> {
            ...
            if (isValid) {
                ...
                // 画面遷移
                Intent intentNext = new Intent(this, StudentSignupCheckActivity.class);
